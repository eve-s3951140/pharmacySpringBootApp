...
class EquipmentsControllerUnitTest {
    ...
    // Test the controller to add a new equipment and expect an error when the service throws an exception
    @Test
    ...
    // Test the controller to update an equipment and expect an error when the service throws an exception
    @Test
    ...
    // Test the controller to delete an equipment by ID and expect an error when the service throws an exception
    @Test
